...
public class CitController {
    ...
    public void citMainframeConnector(@RequestBody JsonNode jsonNode) {
        ...
        try {
            ...
            fileId = jsonNode.get("ptmRequestId").asText();
    ...
    public StringBuilder getHeaderValuesFromJsonNode(JsonNode jsonNode) {
        ...
        while (fields.hasNext()) {
            ...
            if (headerLayoutProperties.containsKey(key)) {
                ...
                String colAlign = headerLayoutProperties.get(key).get(2);

                String ruleField = String.valueOf(formatRuleField(key, value.asText(), columnWidth, columnGapWidth, colAlign));
    ...
    public StringBuilder getFieldValuesFromJsonNode(JsonNode rules) throws IOException {
        ...
        fieldLayoutProperties.putAll("setUpChangeNumber", Arrays.asList("2", "", ""));
        fieldLayoutProperties.putAll("rowNumber", Arrays.asList("10", "", ""));
        fieldLayoutProperties.putAll("entityType", Arrays.asList("25", "", "-"));
        fieldLayoutProperties.putAll("entityOpId", Arrays.asList("18", "", "-"));
        fieldLayoutProperties.putAll("entityAgn", Arrays.asList("10", "", ""));
        fieldLayoutProperties.putAll("eastGrpOpId", Arrays.asList("18", "", "-"));
        fieldLayoutProperties.putAll("srceEntity", Arrays.asList("18", "", "-"));
        fieldLayoutProperties.putAll("srceEntityGr", Arrays.asList("18", "", "-"));
        fieldLayoutProperties.putAll("srceCopay", Arrays.asList("18", "", "-"));
        fieldLayoutProperties.putAll("entityEffDate", Arrays.asList("10", "", "-"));
        fieldLayoutProperties.putAll("channelCde", Arrays.asList("6", "", "-"));
        fieldLayoutProperties.putAll("parentType", Arrays.asList("2", "", "-"));
        fieldLayoutProperties.putAll("parentName", Arrays.asList("18", "", "-"));
        fieldLayoutProperties.putAll("parentAgn", Arrays.asList("10", "", ""));
        fieldLayoutProperties.putAll("operation", Arrays.asList("1", "", "-"));
        fieldLayoutProperties.putAll("clientExclInd", Arrays.asList("1", "", "-"));
        ...
        fieldLayoutProperties.putAll("networkExclInd", Arrays.asList("1", "", "-"));
        ...
        fieldLayoutProperties.putAll("source", Arrays.asList("6", "50", "-"));
        ...
        calculateOffsets(arrayFieldLayoutProperties);
            ...
            while (fields.hasNext()) {
                ...
                if (value.isArray()) {
                    for (JsonNode arrayElement : value) {
                        ...
                        while (arrayFields.hasNext()) {
                            ...
                            if (arrayFieldLayoutProperties.containsKey(arrayKey)) {
                                ...
                                String colAlign = arrayFieldLayoutProperties.get(arrayKey).get(2);
                                String ruleField = String.valueOf(formatRuleField(arrayKey, arrayValue, columnWidth, columnGapWidth, colAlign));
                    ...
                    if (fieldLayoutProperties.containsKey(key)) {
                        ...
                        String colAlign = fieldLayoutProperties.get(key).get(2);
                        String ruleField = String.valueOf(formatRuleField(key, value.asText(), columnWidth, columnGapWidth, colAlign));
                        ruleRow.append(ruleField);
                    }
                }
    ...
    public StringBuilder formatRuleField(String key, String value, String keyColumnWidth, String keySeparatorWidth, String colAlign) {

        StringBuilder ruleField = new StringBuilder();
        ruleField.append(String.format("%" + colAlign + keyColumnWidth + "s" + "%" + keySeparatorWidth + "s", value, ""));
        return ruleField;
    }
    ...
    public void bufferedWriter(StringBuilder content) throws IOException {
        ...
        try {
            ...
            FileWriter fileWriter = new FileWriter("src/main/resources/report_" + fileId + ".txt", true);
